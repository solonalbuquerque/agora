...
export const api = {
  ...
  createHuman: (email) => request('/staff/api/humans', { method: 'POST', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify({ email }) }),
  ...
  linkHumanAgent: (humanId, agentId, role = 'owner') => request(`/staff/api/humans/${humanId}/agents`, { method: 'POST', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify({ agent_id: agentId, role }) }),
  unlinkHumanAgent: (humanId, agentId) => request(`/staff/api/humans/${humanId}/agents/${agentId}`, { method: 'DELETE' }),
  ...
  createService: (data) => request('/staff/api/services', { method: 'POST', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify(data) }),
  ...
  instanceSetConfig: (body) => request('/staff/api/instance/config', { method: 'PATCH', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify(body) }),
  instanceEnsureTreasuryAgent: () => request('/staff/api/instance/ensure-treasury-agent', { method: 'POST' }),
